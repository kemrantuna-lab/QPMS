...
namespace QPMS.Module.Controllers
{
    ...
    public partial class ViewControllerProjectDetailView : ObjectViewController<DetailView,Project>
    {
        // Use CodeRush to create Controllers and Actions with a few keystrokes.
        // https://docs.devexpress.com/CodeRushForRoslyn/403133/
        public ViewControllerProjectDetailView()
        {
            InitializeComponent();
        ...
        protected override void OnActivated()
        {
            ...
            try
            {
                ...
                {
                    if(currentProject.State != State.ON)
                    {
                        var editors = View.GetItems<PropertyEditor>();
                        foreach (var editor in editors)
                        {
                            if (editor.PropertyName != "State")
                            {
