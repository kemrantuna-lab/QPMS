...
namespace QPMS.Module.BusinessObjects
{
    ...
    public class ProjectTimesheetType : BaseObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        // Use CodeRush to create XPO classes and properties with a few keystrokes.
        // https://docs.devexpress.com/CodeRushForRoslyn/118557
        public ProjectTimesheetType(Session session)
            : base(session)
        {
        }
           ...
           && string.IsNullOrEmpty(Code))
            {
                ...
                Code = string.Format("POTT-{0:D8}", nextSequence);
            }
        ...
        [RuleRequiredField("RuleRequiredField for ProjectTimesheetType.Project", DefaultContexts.Save, "A project must be specified")]
        [Association("Project-TimesheetTypes")]
        ...
        [RuleRequiredField("RuleRequiredField for ProjectTimesheetType.Name", DefaultContexts.Save, "A name must be specified")]
        [Size(SizeAttribute.DefaultStringMappingFieldSize)]
        public string Name
        {
            get => name;
