...
namespace QPMS.Module.BusinessObjects
{
    ...
    public class ProjectMember : BaseObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
           ...
           && string.IsNullOrEmpty(Code))
            {
                ...
                Code = string.Format("POME-{0:D8}", nextSequence);
            }
            base.OnSaving();
        }
        ...
        [RuleRequiredField("RuleRequiredField for ProjectMember.Name", DefaultContexts.Save, "A name must be specified for company")]
        [Size(SizeAttribute.DefaultStringMappingFieldSize)]
        public string Name
        {
            get => name;
        ...
        [RuleRequiredField("RuleRequiredField for ProjectMember.Surname", DefaultContexts.Save, "A surname must be specified for company")]
        [Size(SizeAttribute.DefaultStringMappingFieldSize)]
        ...
        [RuleRequiredField("RuleRequiredField for ProjectMember.Email", DefaultContexts.Save, "An email must be specified for company")]
        [Size(SizeAttribute.DefaultStringMappingFieldSize)]
        public string EMail
        {
            get => eMail;
